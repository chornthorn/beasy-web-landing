...
const Contact: React.FC = () => {
  const contactInfo = [
    ...
    {
      title: "Location",
      value: "123 Technology Drive, Suite 100, San Francisco, CA 94105",
      icon: (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-20">
            ...
            >
              ...
              solutions? Let's start a conversation.
            </motion.p>
          </div>
                ...
                <form className="space-y-8">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div className="space-y-2">
                      ...
                      <input
                        ...
                        id="name"
                        name="name"
                        className="w-full h-12 px-4 rounded-full border-2 border-gray-100 focus:border-[#ff6b4a] focus:ring-0 text-gray-600 placeholder-gray-400/60 transition-colors duration-300"
                  ...
                  <div className="space-y-2">
                    ...
                    <textarea
                      ...
                      name="message"
                      rows={4}
                      className="w-full p-4 rounded-3xl border-2 border-gray-100 focus:border-[#ff6b4a] focus:ring-0 text-gray-600 placeholder-gray-400/60 transition-colors duration-300 resize-none"
                  ...
                  <div>
                    <button
                      type="submit"
                      className="w-full h-12 bg-gradient-to-r from-[#ff6b4a] to-[#ff3e3e] text-white rounded-full font-medium text-[15px] hover:from-[#ff3e3e] hover:to-[#ff6b4a] transition-all duration-300 hover:shadow-lg"
                    >
                      Send Message
                    </button>
                  </div>
        ...
        >
          <div className="w-full h-[400px] rounded-2xl overflow-hidden border border-gray-200 shadow-lg">
            <iframe
              ...
              title="Suntel Technology Location"
