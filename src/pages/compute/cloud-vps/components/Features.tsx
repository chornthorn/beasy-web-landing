...
const features = [
  {
    ...
    description: "Powered by latest generation AMD EPYC processors",
    icon: "⚡",
  },
  {
    title: "Instant Setup",
    description: "Deploy your VPS in less than 60 seconds",
    icon: "🚀",
  },
  {
  ...
  {
    title: "99.99% Uptime",
    description: "Enterprise infrastructure with guaranteed availability",
    icon: "✨",
  },
  {
      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-300 max-w-2xl mx-auto">
            Our Virtual Private Servers come packed with features to help you
            run your applications efficiently and securely.
          </p>
        </div>
        ...
        >
          ...
          <p className="text-gray-300 max-w-2xl mx-auto">
            Our VPS solutions are specifically optimized for high-performance
            workloads, featuring the latest AMD EPYC processors and NVMe SSDs.
          </p>
        </motion.div>
      </div>
    </section>
